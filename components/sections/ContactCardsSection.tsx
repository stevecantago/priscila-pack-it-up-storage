...
export function ContactCardsSection({ intro = false }: ContactCardsSectionProps) {
  return (
    <section className="bg-slate-50 py-12">
      <div className="section-shell">
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_0.85fr]">
          <div className="motion-card rounded-lg border bg-white p-6 shadow-sm">
          ...
          <aside className="space-y-5">
            <div className="motion-card motion-wiggle rounded-lg border bg-white p-6 shadow-sm">
              ...
              <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                ...
                <Button asChild variant="outline">
                  <TrackedAnchor
                    ...
                    eventParams={{ location: "contact_cards" }}
                  >
                    Facility Details
                  </TrackedAnchor>
                </Button>
            ...
            <GoogleMapCard className="rounded-lg" />
          </aside>
        </div>
      </div>
    </section>
